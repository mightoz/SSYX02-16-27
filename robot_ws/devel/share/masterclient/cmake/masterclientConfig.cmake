...
if("TRUE" STREQUAL "TRUE")
  set(masterclient_SOURCE_PREFIX /home/multipos2/SSYX02-16-27/robot_ws/src/masterclient)
  set(masterclient_DEVEL_PREFIX /home/multipos2/SSYX02-16-27/robot_ws/devel)
  ...
  set(masterclient_INSTALL_PREFIX /home/multipos2/SSYX02-16-27/robot_ws/install)
...
if(NOT "/home/multipos2/SSYX02-16-27/robot_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'masterclient' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/multipos2/SSYX02-16-27/robot_ws/src/masterclient/${idir}'.  Ask the maintainer 'Oscar Beronius <oscar.beronius@gmail.com>' to fix it.")
    endif()
...
set(masterclient_EXPORTED_TARGETS "masterclient_generate_messages_cpp;masterclient_generate_messages_lisp;masterclient_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${masterclient_dep}_FOUND)
      find_package(${masterclient_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${masterclient_dep} REQUIRED ${depend_list})
  endif()
