...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'masterclient' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/multipos2/SSYX02-16-27/robot_ws/install/${idir}'.  Ask the maintainer 'Oscar Beronius <oscar.beronius@gmail.com>' to fix it.")
    endif()
